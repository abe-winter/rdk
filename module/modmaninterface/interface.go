...
type ModuleManager interface {
	Add(ctx context.Context, packagesDir string, confs ...config.Module) error
	Reconfigure(ctx context.Context, packagesDir string, cfg config.Module) ([]resource.Name, error)
